...
function Footer() {
  ...
  <p className='text-xs mt-2 text-gray-500'>  © Ademola Mayowa {new Date().getFullYear() } All Rights Reserved Ademola Mayowa {new Date().getFullYear() } All Rights Reserved</p>
</div>
  )
}
